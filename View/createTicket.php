	...
	<div class="container-fluid" >
		<div id="wrapper">
			...
			<div class="box">
				...
				<form class="bootstrap-form needs-validation" action="../Controller/createIssue-C.php" name="general" method="POST" class="form-group" novalidate>
				<input type="hidden" name="issueType" value= <?php echo($issueType) ?> >
						...
						<div class="col-xl-12 col-md-12 col-xs-12 col-sm-12">												
							<div class="group">   
								<div> 							
									...
									<input type="hidden" name="suportTo" value= <?php echo($suportTo) ?> >
									<span class="highlight"></span>
									<span class="bar"></span>
